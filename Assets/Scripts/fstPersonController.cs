...
public class fstPersonController : MonoBehaviour
{
    ...
    private void Start()
    {
		...
		txtH2 = GameObject.Find("H2Text").GetComponent<Text>();
		txtV2 = GameObject.Find("V2Text").GetComponent<Text>();
...
//    }
    ...
    private void GetInput(out float speed)
    {
        ...
        // *** add animation stuff in this function
		...
		// ***
		float xyspeed = Mathf.Max(Mathf.Abs(m_Input.x), Mathf.Abs(m_Input.y));
        ...
        m_Anim.SetFloat("Speed", xyspeed);
		txtSpeed.text = xyspeed.ToString();
		txtH.text = horizontal.ToString();
		txtV.text = vertical.ToString();
		txtH2.text = horizontal2.ToString();
		txtV2.text = vertical2.ToString();
		// ***
...
//    }
	...
	// ***
	void FireGun() {
		Transform camTrans = GetComponentInChildren<Camera>().GetComponent<Transform>();
		RaycastHit hit;
		float range = 2000f;
